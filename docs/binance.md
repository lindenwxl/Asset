...
Binance(币安)的资产数据根据 [Binance官方文档](https://github.com/binance-exchange/binance-official-api-docs/blob/master/rest-api.md) 提供的方式，
通过REST API的方式，定时请求Binance服务器相关账户的资产详情，然后资产服务器打包处理数据，通过资产事件的形式推送至事件中心。
